...
src_prepare() {
	...
	then
		...
		# Fix gcc_plugin_randstruct : https://github.com/tonyhutter/zfs/commit/30d8b8570243fe5b944f26a964cf5204cb1e71e0
		epatch "${FILESDIR}/fix_gcc_plugin_randstruct.patch"
	fi
